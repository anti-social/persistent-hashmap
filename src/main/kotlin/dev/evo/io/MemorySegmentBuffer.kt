...
open class MemorySegmentBuffer(protected val segment: MemorySegment) : IOBuffer {
...
class MutableMemorySegmentBuffer(segment: MemorySegment) : MemorySegmentBuffer(segment), MutableIOBuffer {
